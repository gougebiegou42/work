	...
	s.Group("/", func(group *ghttp.RouterGroup) {
		group.Group("/system", func(group *ghttp.RouterGroup) {
			...
			group.Group("/auth", func(group *ghttp.RouterGroup) {
				...
				//! JayceDemo
				group.GET("jayceList", api.JayceDemo.List)
				group.GET("jayceGet", api.JayceDemo.Get)
				group.POST("jayceAdd", api.JayceDemo.Add)
				group.PUT("jayceEdit", api.JayceDemo.Edit)
				group.DELETE("jayceDelete", api.JayceDemo.Delete)
				//用户管理
			...
			//todo Sylas
			group.Group("/sylas", func(group *ghttp.RouterGroup) {
				group.GET("List", api.Sylas.List)
				group.GET("Get", api.Sylas.Get)
				group.POST("Add", api.Sylas.Add)
