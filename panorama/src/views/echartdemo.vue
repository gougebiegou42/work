...
import aaa from 'echarts/map/js/province/xizang.js'
...
export default {
  ...
  methods: {
    ...
    chinaMapHidden(chinaMap) {
      let that = this
      const modules = import.meta.glob('../../node_modules/echarts/map/js/province/*.js');
      ...
      chinaMap.on('click', async function(params) {
        if (params.name in that.provinces) {
          // modules["../../node_modules/echarts/map/js/province/anhui.js"]().then(data => {
          //   console.log(data);
          // })
          // modules[`../../node_modules/echarts/map/js/province/${that.provinces[params.name]}.js`]().then(data => {
          //   console.log(data);
          // })
          // let s = await aaa
          // if (s) {
    ...
    chinaMaprsult(name = null) {
      ...
      let chinaMap = _this.$echarts.init(this.$refs.china_map)
      this.options = {
